...
Keep planning and standards documents current and well-structured. `/replan` manages the tactical backlog (PLAN.md), `/makegoals` generates strategic goal documents (GOALS.md), and `/claude:optimize-md` audits CLAUDE.md files against best practices — ensuring project documentation evolves alongside the code.
